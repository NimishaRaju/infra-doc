...
def cpu_health_check(cpu_speed_limit: float)->str:
...
def memory_health_check(memory_status: str)->str:
...
def disk_health_check(smart_status: str)->str:
...
def bat_health_check(condition: str)->str:
...
def net_health_check(ierrors: int,oerrrs: int )->str:
...
def sys_panic_check(panicerr:str)->str:
...
#sudo thermal levels
def thermal_lev_check(cpu:int,gpu:int,io:int)->str:
